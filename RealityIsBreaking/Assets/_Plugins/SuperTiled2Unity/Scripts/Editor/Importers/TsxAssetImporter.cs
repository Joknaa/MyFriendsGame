...
namespace SuperTiled2Unity.Editor {
    ...
    public class TsxAssetImporter : TiledAssetImporter {
        ...
        [SerializeField] private bool m_UseSpriteAtlas = true;

        [SerializeField] private AtlasSize m_AtlasWidth = AtlasSize._2048;

        [SerializeField] private AtlasSize m_AtlasHeight = AtlasSize._2048;

        public bool UseSpriteAtlas => m_UseSpriteAtlas;
        public int AtlasWidth => (int) m_AtlasWidth;
        public int AtlasHeight => (int) m_AtlasHeight;
